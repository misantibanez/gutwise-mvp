...
export class AzureAuthService {
  ...
  /**
   * Sign in user (redirect to Azure login or simulate in development)
   */
  signIn(): void {
  ...
  /**
   * Get mock authenticated user for development mode sign in simulation
   */
  getMockSignedInUser(): AuthInfo {
    return {
      isAuthenticated: true,
      user: {
        id: 'mock-user-id',
  ...
  /**
   * Development mode - return unauthenticated state by default
   * Authentication happens via demo mode or explicit sign in
   */
  getMockAuthInfo(): AuthInfo {
    // Always start unauthenticated in development to show login screen
    return this.getUnauthenticatedState();
  }
