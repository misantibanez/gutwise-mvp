...
export function GamificationDisplay({ variant = 'full', showDoctorShare = true }: GamificationDisplayProps) {
  ...
  if (variant === 'mini') {
    return (
      <Card className="bg-gradient-to-r from-gray-800 to-gray-700 border-gray-600 p-4">
        <div className="space-y-3">
          {/* Level with progress indicator */}
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">{levelProgress.current}/{levelProgress.needed} XP to Level {stats.level + 1}</div>
              </div>
            </div>
            <div className="w-16">
              <Progress 
                ...
                style={{ '--progress-background': '#f59e0b' } as React.CSSProperties}
              />
            </div>
          </div>

          {/* Streak and achievements in a clean grid */}
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center space-x-2 bg-gray-700/50 rounded-lg p-2">
              <Flame className="w-4 h-4 text-orange-400" />
              <div>
                <div className="text-sm text-orange-400 font-medium">{stats.currentStreak} days</div>
            ...
            <div className="flex items-center space-x-2 bg-gray-700/50 rounded-lg p-2">
              ...
              <div>
                <div className="text-sm text-blue-400 font-medium">{stats.achievements.length} earned</div>
      ...
      <Card className="bg-gray-800 border-gray-700 p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Progress 
              value={weeklyProgress.mealsProgress} 
              className="h-2 bg-gray-700"
              style={{ '--progress-background': '#10b981' } as React.CSSProperties}
            />
          </div>
          ...
          <div>
            ...
            <Progress 
              value={weeklyProgress.symptomsProgress} 
              className="h-2 bg-gray-700"
